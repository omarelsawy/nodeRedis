/* https://github.com/stockholmux/fromsqltoredis/blob/master/chapter1/between-range.node.js */
var
    ...
    client      = redis.createClient(),            // Client object for connection to the Redis server
...
function betweenRange() {
    ...
    client
        ...
        .zremrangebyscore('temp','-inf',99)             // from negative infinity to start
        .zremrangebyscore('temp',300,'+inf')               // from end to positive infinity
        .sort(                                                  // SORT command
